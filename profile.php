...
<!--                       <img src="#" alt="#">-->
               ...
               <div class="collapse navbar-collapse" id="mine">
                   ...
                   <ul class="nav navbar-nav navbar-right">
                       <li>
                           <a href="#" class="dropdow-toggle" id="cart-container" data-toggle="dropdown"><span class="fa  fa-cart-plus fa-default"></span>Cart <span class="badge" id="cartCount">0</span></a>
                       ...
                       <li>
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                 <span class="fa fa-user fa-default"></span>Hi <?php echo $_SESSION["firstName"]?>
                            </a>
                            <ul class="dropdown-menu" style="list-style:none; background-color: #444;">
                                <li><a href="content/pages/cart.php" class="text-primary"><span class="fa fa-cart-plus"></span> Cart</a></li>
                                <li><a href="content/pages/reset-password.php" >Change Password</a></li>
                                <li><a href="content/pages/logout.php" >Logout</a></li>
                            </ul>
                       </li>
                   </ul>
               </div>
